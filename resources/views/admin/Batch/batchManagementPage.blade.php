...
@section('adminSide')
              ...
              @endif
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <a href="#" class="btn btn-lg btn-primary ml-4 showModal"  style="float: right;">Add Batch</a>
                      <table class="table table-striped" id="table-2">
                        ...
                        <tbody>
                          ...
                          <td>
                            <a href="{{ url('updateBatch') }}/{{ $item->id }}" class="btn btn-primary"><i class="material-icons">edit</i></a>
                             <a href="batchDelete" dele-id='{{$item->id}}'   class="btn btn-danger comDel" ><i class="material-icons deleteModal">delete</i></a>
                          </td>
                          </tr>
                          @endforeach
                        </tbody>
  ...
  @include('admin.modals.addBatchModal')
@endsection
@section('adminJsFile')
