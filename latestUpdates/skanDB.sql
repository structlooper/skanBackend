...
--
-- Host: localhost
-- Generation Time: Mar 26, 2020 at 01:29 PM
...
(1, 'testing heading', 'updated from home', '5e745c89415ce.jpg', '2020-03-17 18:30:00', '2020-03-21 11:21:49');
...
--
-- Table structure for table `lastest_updates`
--

CREATE TABLE `lastest_updates` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `title` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `link` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `desc` varchar(999) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `lastest_updates`
--

INSERT INTO `lastest_updates` (`id`, `title`, `link`, `desc`, `created_at`, `updated_at`) VALUES
(2, 'test', 'https://github.com/structlooper/skanBackend/tree/updated', 'testing desc', '2020-03-26 06:28:11', '2020-03-26 06:28:11'),
(3, 'test', 'https://github.com/structlooper/skanBackend/tree/master/updated', 'desc', '2020-03-26 06:28:29', '2020-03-26 06:28:29'),
(4, 'test', 'https://github.com/structlooper/skanBackend/tree/master/updated', 'desc', '2020-03-26 06:29:40', '2020-03-26 06:29:40');
...
(9, 2, 'new', '150', '2020-03-18 05:39:39', '2020-03-25 06:22:00'),
...
(44, '2020_03_23_045833_create_video_tutorials_table', 28),
(45, '2020_03_26_112230_create_lastest_updates_table', 29);
...
(11, 6, 'question 1', 'opt 1', 'opt 2', 'opt 3', NULL, 'option_4', 'sample', '2020-03-18 05:56:36', '2020-03-21 11:29:38'),
...
(4, 'karan', 'partap', 'aran3170087', '1234567890', 'hashtagkaran, New Delhi', 110045, 'test@gmail.com', 'http://localhost/skanBack/uploades/profileImages/aran3170087.png', NULL, '$2y$10$AimdiK9U.dzRDgomTOe7Wu5FDXtCN7u4HcLZoO6ic37X7nzCV2wLK', NULL, '2020-02-24 00:51:50', '2020-03-24 06:06:55', 'user', 'active'),
...
(6, 'Deepak', 'sinha', 'n5294784', '0987654321', NULL, NULL, 'admin@gmail.com', 'n5294784.jpg', NULL, '$2y$10$lUtqQNWz9t6KmXO75U5axeO5of.nprdne4vs3mZICJ18xfJvU9jh2', NULL, '2020-02-25 00:09:55', '2020-03-21 11:41:37', 'admin', 'active'),
...
(64, 'sample', 'sample', 'mple3551474', '0987654326', NULL, NULL, 'sample@mail.com', NULL, NULL, '$2y$10$fYabq2Rxsb/.PT1qA8qbF.cNJ847vc1yK9ENLwh3OFH/i037x/BaG', NULL, '2020-03-17 04:05:33', '2020-03-21 10:30:53', 'user', 'active'),
...
INSERT INTO `video_tutorials` (`id`, `category`, `source`, `name`, `video`, `link`, `desc`, `created_at`, `updated_at`) VALUES
(4, 2, 'Select Source', 'testing 2', NULL, NULL, 'description updated', '2020-03-23 05:01:53', '2020-03-24 01:36:01');
...
--
-- Indexes for table `lastest_updates`
--
ALTER TABLE `lastest_updates`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `video_tutorials`
  ADD PRIMARY KEY (`id`),
  ADD KEY `video_tutorials_category_foreign` (`category`);
...
--
-- AUTO_INCREMENT for table `lastest_updates`
--
ALTER TABLE `lastest_updates`
...
--
ALTER TABLE `video_tutorials`
  ADD CONSTRAINT `video_tutorials_category_foreign` FOREIGN KEY (`category`) REFERENCES `category_datas` (`id`);
COMMIT;
